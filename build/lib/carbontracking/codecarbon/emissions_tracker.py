...
class BaseEmissionsTracker(ABC):
    ...
    def flush(self) -> Optional[float]:
        ...
        #print("ENERGY_DIST", self._energy_distr)
        return emissions_data, self._energy_distr, self._total_cpu_energy, self._total_gpu_energy
    ...
    def _do_measurements(self) -> None:
        for hardware in self._hardware:
            ...
            #print("POWER", power, "ENERGY", energy, "HARDWARE", hardware)

            self._energy_distr[str(hardware.description())] = energy.kWh
